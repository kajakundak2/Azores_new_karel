...
export const TravelPortal: React.FC<TravelPortalProps> = ({
  ...
  // The flag is set in LandingPage before navigating here, so we consume it once on mount.
  ...
  useEffect(() => {
    ...
    if (shouldGenerate) {
      ...
      // Small delay to allow the portal to fully mount and useItineraryAI to initialize
